...
.wlr-myaccount-page .wlr-heading {
    <?php echo !empty($heading_color) ? esc_attr("color:". $heading_color . " !important;"): "";
    ?><?php echo !empty($theme_color) ? esc_attr("border-left: 3px solid ". $theme_color . " !important;"): "";
    ?>
}
...
<div class="wlr-myaccount-page">
    ...
    <div class="wlr-user-details" <?php echo esc_attr($style); ?>>
        <div class="wlr-heading-container">
            <h3 class="wlr-heading">
                <?php echo esc_html(sprintf(__('My %s', 'wp-loyalty-rules'), $base_helper->getPointLabel(3))); ?></h3>
        </div>
            ...
            <div id="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-levels') ?>" style="min-height: 190px">
                ...
                <div class="level-points">
                    <div class="wlr-progress-bar">
                        <div class="wlr-progress-level" style="<?php echo esc_attr('width:' . $css_width . '%'); ?>">
        ...
        <div class="wlr-referral-blog">
            ...
            <?php endif; ?>
            <?php if (
                    isset($is_social_share_available) && $is_social_share_available === 'yes'
        ...
        <div class="wlr-your-reward">
            <div class="wlr-heading-container">
                <h3 class="wlr-heading"><?php esc_html_e('My rewards', 'wp-loyalty-rules') ?></h3>
            </div>
            <div class="wlr-customer-reward">
                ...
                ?>
                <div
                    class="<?php echo (isset($u_reward->discount_code) && !empty($u_reward->discount_code)) ? 'wlr-coupon-card' : 'wlr-reward-card'; ?>">
                    ...
                    <div class="wlr-card-container">
                        <div class="wlr-card-icon-container">
                            ...
                            <div style="display: flex;gap: 3px;">
                                ...
                                <div class="wlr-revert-tool"
                                    ...
                                    <img
                                        src="<?php echo isset($point_revert_icon) && !empty($point_revert_icon) ? esc_url($point_revert_icon) : '' ?>" />
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="wlr-card-inner-container">
                            ...
                            <div class="wlr-code" style="<?php echo esc_attr($coupon_border); ?>">
                                <div class="wlr-coupon-code" style="<?php echo esc_attr($coupon_background); ?>">
                        ...
                        <p class="wlr-expire-date">
                            <?php echo esc_html(sprintf(__("Expires on %s", "wp-loyalty-rules"), $u_reward->expiry_date)); ?>
                        </p>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="wlr-transaction-blog" id="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-details-table') ?>">
            <div class="wlr-heading-container">
                ...
                <table>
                    <thead id="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-table-header') ?>">
                        <tr>
                            ...
                            <th class="set-center">
                                <?php echo esc_html__($earn_helper->getPointLabel(3), 'wp-loyalty-rules') ?></th>
                    ...
                    <tr>
                        ...
                        <td class="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-table-body') ?>">
                            <?php echo esc_html($earn_helper->getActionName($transaction->action_type)); ?></td>
                        <td class="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-table-body') ?>">
                            <?php echo esc_html(isset($transaction->processed_custom_note) && !empty($transaction->processed_custom_note) ? $transaction->processed_custom_note : $transaction->customer_note);
                                    ?></td>
                        <td class="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-table-body') ?> set-center">
                            <?php echo ($transaction->points == 0) ? "-" : (int)$transaction->points; ?></td>
                        <td class="<?php echo esc_attr(WLR_PLUGIN_PREFIX . '-transaction-table-body') ?>">
                            <?php echo esc_html(!empty($transaction->reward_display_name) ? $transaction->reward_display_name : '-'); ?>
                        </td>
                    </tr>
        ...
        <div class="wlr-earning-options">
            ...
            <div class="wlr-campaign-container">
                ...
                <div class="wlr-card wlr-earning-option "
                    <?php echo ((isset($user) && $user->id > 0 || get_current_user_id() > 0) && isset($campaign->action_type) && $campaign->action_type == 'followup_share' && isset($campaign->share_url)) ?
                    ...
                    <p class="wlr-discount-point">
                        <?php esc_html_e($campaign->campaign_title_discount, 'wp-loyalty-rules'); ?></p>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if ($can_edit_birthdate) : ?>
                    <div class="wlr-date-editor" id="<?php echo esc_attr('wlr-birth-date-input-' . $campaign->id); ?>"
                        style="display: none;">
                        ...
                        <div class="wlr-date-editor-container">
                            <input class="wlr-input-date" type="date" max="<?php echo esc_html(date("Y-m-d")) ?>"
